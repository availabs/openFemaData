...
//                                                acc.fema_crop += (+get(curr, ['hlr_fc'], 0) * tmpNRIExposure.expa * tmpNRIExposure.afreq) || 0;
                                                ...
                                                acc.buildings += (+get(curr, ['swd_buildings'], 0)) || 0;
                                                acc.crop += (+get(curr, ['swd_crop'], 0)) || 0;
                                               acc.population += (+get(curr, ['swd_population'], 0)) || 0;
    ...
    return (
        <AdminLayout>
            <div className="w-full max-w-7xl mx-auto pb-5">
                ...
                {renderChart(chartData.per_basis, 'hazard', null, ['buildings', 'population', 'crop'], 'SWD')}
                {renderChart(chartData.per_basis, 'hazard', null, ['fema_buildings', 'fema_population', 'fema_crop'], 'FEMA')}
            </div>
        </AdminLayout>
    )
}
